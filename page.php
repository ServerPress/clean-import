...
<?php
						...
						ds_clean_import_radio( 'logrecords', 'Skip importing log records:', $settings['logrecords'], $yes_no, 'If "Yes", Clean Import will not import log records from plugins such as Gravity Forms, iThemes, Pretty Links, Wordfence, etc.' );
